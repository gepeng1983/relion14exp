...
enum EMDLabel
{
    ...
    EMDL_MLMODEL_HELIX_RISE,
    EMDL_MLMODEL_HELIX_TURN,
    ...
    EMDL_OPTIMISER_IMPOSE_HELIX,
    EMDL_OPTIMISER_SEARCH_HELIX,
    EMDL_OPTIMISER_HELIX_INNER_RADIUS,
    EMDL_OPTIMISER_HELIX_OUTER_RADIUS,
    EMDL_OPTIMISER_HELIX_SUPERSAMPLE,
    EMDL_OPTIMISER_HELIX_INCLUDED_PORTION,
...
private:
	...
	EMDL::addLabel(EMDL_CTF_PA, EMDL_DOUBLE, "rlnAdditionalPhase", "Additional phase shift by phaseplate in degree");
	...
	EMDL::addLabel(EMDL_MLMODEL_HELIX_RISE, EMDL_DOUBLE, "rlnHelixRise", "Rise per subunit of a helix in angstrom");
	EMDL::addLabel(EMDL_MLMODEL_HELIX_TURN, EMDL_DOUBLE, "rlnHelixTurn", "Turn per subunit of a helix in degree");
	...
	EMDL::addLabel(EMDL_OPTIMISER_IMPOSE_HELIX, EMDL_BOOL, "rlnImposeHelix", "Flag to indicate whether to impose helical symmetry");
	EMDL::addLabel(EMDL_OPTIMISER_SEARCH_HELIX, EMDL_BOOL, "rlnSearchHelix", "Flag to indicate whether to refine helical symmetry");
	EMDL::addLabel(EMDL_OPTIMISER_HELIX_INNER_RADIUS, EMDL_DOUBLE, "rlnHelixInner", "Inner radius limit for imposing and refining helical symmetry in angstrom");
	EMDL::addLabel(EMDL_OPTIMISER_HELIX_OUTER_RADIUS, EMDL_DOUBLE, "rlnHelixOuter", "Outer radius limit for imposing and refining helical symmetry in angstrom");
	EMDL::addLabel(EMDL_OPTIMISER_HELIX_SUPERSAMPLE, EMDL_LONG, "rlnHelixSuperSample", "Super-sampling ratio for intermediate volumes during helical averaging");
	EMDL::addLabel(EMDL_OPTIMISER_HELIX_INCLUDED_PORTION, EMDL_DOUBLE, "rlnHelixTake", "Portion of input volume (at center) taken into helical averaging");
